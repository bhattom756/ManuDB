...
const TopNavbar = ({ onMenuClick, user, isMobile = false }) => {
          ...
          <div className="flex items-center space-x-4">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="flex items-center space-x-2 lg:space-x-3 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
